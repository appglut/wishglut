...
class dynamicStyle {
	...
	public function dynamicCss() {
        ...
        .wishglut-wishlist-table thead tr {
            background-color: {$tableHeaderColor};
            color: {$tableHeaderFontColor};
        }
        .wishglut-wishlist-table tbody tr {
            background-color: {$tableBodyColor};
            color: {$bodyFontColor};
        }
        .wishglut-wishlist-table tbody tr:hover {
    ...
    ";
		...
		if ( $bodyColorChoice === 'body-oddeven-color' ) {
			$dynamic_css .= "
            .wishglut-wishlist-table tbody tr:nth-child(odd) {
                background-color: {$oddRowColor};
            }
            .wishglut-wishlist-table tbody tr:nth-child(even) {
    ...
    ";
		...
		$dynamic_css .= "
    .wishglutw-subscribe-notification-btn {
	 ...
	 .wishglutw-subscribe-notification-btn:hover {
        background-color: {$subscribeButtonColor} !important;
        color: {$subscribeButtonFontColor} !important;
    }
";
		...
		$dynamic_css .= "
            .wishglut_wishlist.single-product .button {
           ...
           .wishglut_wishlist.single-product .button i {
                color: {$wishlistIconColor};
            }
        ";

		$dynamic_css .= "
            .wishglut_wishlist.single-product .button.login-required {
           ...
           .wishglut_wishlist.single-product .button.login-required i {
		...
		$dynamic_css .= "
            .wishglut_wishlist_movelist.single-product .button.move_to_list {
		...
		$dynamic_css .= "
    .wishglut_wishlist.shop-page .button {
    ...
    .wishglut_wishlist.shop-page .button i {
        color: {$shopIconColor};
    }
    .wishglut_wishlist_movelist.shop-page .button.move_to_list {
...
";
		...
		$dynamic_css .= "
    .wishglut_wishlist.archive-page .button {
    ...
    .wishglut_wishlist.archive-page .button i {
        color: {$archiveIconColor};
    }
    .wishglut_wishlist_movelist.archive-page .button.move_to_list {
...
";
		...
		$dynamic_css .= "
			...
			.wishglut-social-share .share-title {
			...
			.wishglut-social-share .social-share-btn {
				display: inline-flex;
				align-items: center;
			...
			.wishglut-social-share .social-share-btn:hover {
				opacity: " . ($shareButtonHoverOpacity / 100) . ";
			}

			.wishglut-social-share .social-share-btn i {
				font-size: calc({$shareButtonSize['width']}{$shareButtonSize['unit']} * 0.5);
			}

			.wishglut-social-share .facebook-share {
				background-color: {$shareFacebookColor};
			}

			.wishglut-social-share .twitter-share {
				background-color: {$shareTwitterColor};
			}

			.wishglut-social-share .whatsapp-share {
				background-color: {$shareWhatsappColor};
			}

			.wishglut-social-share .pinterest-share {
				background-color: {$sharePinterestColor};
			}

			.wishglut-social-share .linkedin-share {
				background-color: {$shareLinkedinColor};
			}

			.wishglut-social-share .telegram-share {
				background-color: {$shareTelegramColor};
			}

			.wishglut-social-share .email-share {
