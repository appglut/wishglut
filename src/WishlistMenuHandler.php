...
class WishlistMenuHandler {
    ...
    private $menu_slug = 'shopglut_wishlist'; // Default menu slug (ShopGlut submenu)
    ...
    public function getAGSHOPGLUTInstance() {
        ...
        if (class_exists('AGSHOPGLUT_Options')) {
            ...
            if (isset(AGSHOPGLUT_Options::$instances) && is_array(AGSHOPGLUT_Options::$instances)) {
                foreach (AGSHOPGLUT_Options::$instances as $key => $instance) {
                    if ($key === 'agshopglut_wishlist_options') {
        ...
        if (class_exists('AGSHOPGLUT') && isset(AGSHOPGLUT::$inited)) {
            if (isset(AGSHOPGLUT::$inited['agshopglut_wishlist_options'])) {
        ...
        global $agshopglut_wishlist_options;
        if (isset($agshopglut_wishlist_options) && is_object($agshopglut_wishlist_options)) {
            $this->agshopglut_instance = $agshopglut_wishlist_options;
            return;
        }
    ...
    private function tryRecreateInstance() {
        ...
        if (isset(AGSHOPGLUT::$args['sections']['agshopglut_wishlist_options'])) {
            $sections = AGSHOPGLUT::$args['sections']['agshopglut_wishlist_options'];
            $args = isset(AGSHOPGLUT::$args['admin_options']['agshopglut_wishlist_options']) ? 
                    AGSHOPGLUT::$args['admin_options']['agshopglut_wishlist_options'] : array();

            try {
                $this->agshopglut_instance = new AGSHOPGLUT_Options('agshopglut_wishlist_options', array(
                    'args' => $args,
                    'sections' => $sections
                ));
            } catch (Exception $e) {
    ...
    private function findInstanceInGlobals() {
        ...
        foreach ($GLOBALS as $var_name => $var_value) {
            if (is_object($var_value) && 
                ...
                $var_value->unique === 'agshopglut_wishlist_options') {
    ...
    private function createFallbackInstance() {
        ...
        $options = get_option('agshopglut_wishlist_options', array());
        ...
        $fallback->unique = 'agshopglut_wishlist_options';
   ...
   public function render() {
    ...
    ?>
    <div class="wrap shopglut-wishlist-wrapper">
        ...
        <nav class="nav-tab-wrapper wp-clearfix" aria-label="Secondary menu">
            ...
            <!-- <a href="<?php echo esc_url( $this->getTabUrl( 'analytics' ) ); ?>" 
               class="nav-tab <?php echo $current_tab === 'analytics' ? 'nav-tab-active' : ''; ?> <?php echo !$is_pro ? 'nav-tab-pro-locked' : ''; ?>">
                📈 <?php echo esc_html__('Analytics', 'shopglut'); ?>
            ...
            <a href="<?php echo esc_url( $this->getTabUrl( 'integrations' ) ); ?>" 
               class="nav-tab <?php echo $current_tab === 'integrations' ? 'nav-tab-active' : ''; ?> <?php echo !$is_pro ? 'nav-tab-pro-locked' : ''; ?>">
                🔌 <?php echo esc_html__('Integrations', 'shopglut'); ?>
                <?php if (!$is_pro): ?><span class="pro-badge">PRO</span><?php endif; ?>
            </a> -->
            ...
            class="nav-tab <?php echo $current_tab === 'users' ? 'nav-tab-active' : ''; ?> <?php echo !$is_pro ? 'nav-tab-pro-locked' : ''; ?>">
                📧 <?php echo esc_html__('Email Management', 'shopglut'); ?>
                <?php if (!$is_pro): ?><span class="pro-badge">PRO</span><?php endif; ?>
          </a>
        ...
        <!-- Tab Content -->
        <div class="shopglut-wishlist-settings tab-content-wrapper">
            <?php
            switch ($current_tab) {
                case 'dashboard':
...
private function renderDefaultProTabStyles() {
    ...
    if (has_filter('shopglut_pro_tab_custom_styles')) {
        echo esc_html( wp_strip_all_tags( apply_filters( 'shopglut_pro_tab_custom_styles', '' ) ) );
        return;
    }
    ?>
    <style>
    ...
    <?php echo esc_html( wp_strip_all_tags( apply_filters( 'shopglut_pro_tab_additional_styles', '' ) ) ); ?>
    </style>
    <?php
}
            ...
            <div class="system-info-section">
                ...
                <div class="system-info-grid">
                    <div class="info-item">
                        ...
                        <span><?php echo defined('SHOPGLUT_VERSION') ? esc_html( SHOPGLUT_VERSION ) : '1.0.0'; ?></span>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        ...
                        <span><?php echo defined('WC_VERSION') ? esc_html( WC_VERSION ) : esc_html__('Not Installed', 'shopglut'); ?></span>
                    </div>
                    <div class="info-item">
...
<script>
    ...
    function copySystemInfo() {
        const systemInfo = `
        Plugin Version: <?php echo defined('SHOPGLUT_WISHLIST_VERSION') ? esc_html( SHOPGLUT_WISHLIST_VERSION ) : '1.0.0'; ?>
                                    ...
                                    <div class="agl-section agl-onload" data-section-id="<?php echo esc_attr(sanitize_title($section['title'] ?? '')); ?>">
                                        ...
                                        <?php else: ?>
                                            <div class="agl-no-option">
                                                <?php echo esc_html__('No enhancements available for this section.', 'shopglut'); ?>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div class="agl-buttons">
                                ...
                                <?php if (isset($instance->args['show_reset_section']) && $instance->args['show_reset_section']): ?>
                                    <input type="submit" name="agl_transient[reset_section]" 
                                           ...
                                           data-confirm="<?php echo esc_attr__('Are you sure to reset this section enhancements?', 'shopglut'); ?>">
                                <?php endif; ?>
                            </div>
                            <div class="clear"></div>
                        </div>
    ...
    private function renderBasicOptionsForm($instance) {
        ...
        <div class="basic-enhancements-form">
            ...
            <form method="post" action="options.php">
                <?php settings_fields('agshopglut_wishlist_options'); ?>
                                ...
                                <?php if (is_bool($value) || $value === '1' || $value === '0'): ?>
                                    <label>
                                        <input type="checkbox" 
                                               ...
                                               name="agshopglut_wishlist_options[<?php echo esc_attr($key); ?>]" 
                                               value="1" 
                                               <?php checked($value, 1); ?>>
    ...
    public function getAllOptions() {
        ...
        if (!$instance || !isset($instance->options)) {
            return get_option('agshopglut_wishlist_options', array());
        }
    ...
    private function renderSettingsStyles() {
        ?>
        <style>
        .shopglut-wishlist-settings .agl-enhancements {
             margin-top:0px;
			 padding-top:8px;
		}
    ...
    private function renderDashboardTab() {
        ...
        ?>
        <div class="shopglut-dashboard-container">
            <div class="dashboard-header">
                <h1><?php echo esc_html__('Wishlist Dashboard', 'shopglut'); ?></h1>
                <p class="dashboard-subtitle"><?php echo esc_html__('Overview of your wishlist performance and analytics', 'shopglut'); ?></p>
            </div>
            ...
            <div class="dashboard-metrics-grid">
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        ...
                        <p><?php echo esc_html__('Total Users', 'shopglut'); ?></p>
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        ...
                        <p><?php echo esc_html__('Guest Users', 'shopglut'); ?></p>
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        ...
                        <p><?php echo esc_html__('Registered Users', 'shopglut'); ?></p>
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        ...
                        <p><?php echo esc_html__('Total Wishlists', 'shopglut'); ?></p>
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        ...
                        <p><?php echo esc_html__('Products in Wishlists', 'shopglut'); ?></p>
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        ...
                        <p><?php echo esc_html__('Avg Products/Wishlist', 'shopglut'); ?></p>
            ...
            <div class="dashboard-tables-section">
                <div class="table-container">
                    <div class="table-header">
                        <h3><?php echo esc_html__('Recent Wishlist Activity', 'shopglut'); ?></h3>
                        <div class="table-actions">
                            <select id="user-type-filter">
                                <option value="all"><?php echo esc_html__('All Users', 'shopglut'); ?></option>
                                <option value="registered"><?php echo esc_html__('Registered Users', 'shopglut'); ?></option>
                                <option value="guest"><?php echo esc_html__('Guest Users', 'shopglut'); ?></option>
                            </select>
                            <a href="#" class="view-all-btn">
                                <?php echo esc_html__('View All', 'shopglut'); ?>
                            </a>
                        </div>
                    </div>
                    <div class="table-content">
                        <table class="dashboard-table">
                            <thead>
                                <tr>
                                    <th><?php echo esc_html__('User', 'shopglut'); ?></th>
                                    <th><?php echo esc_html__('Type', 'shopglut'); ?></th>
                                    <th><?php echo esc_html__('Product', 'shopglut'); ?></th>
                                    <th><?php echo esc_html__('Action', 'shopglut'); ?></th>
                                    <th><?php echo esc_html__('Date', 'shopglut'); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr data-user-type="<?php echo esc_attr($activity['user_type']); ?>">
                                    ...
                                    <td>
                                        <span class="user-type-badge <?php echo esc_attr($activity['user_type']); ?>">
                                            <?php echo $activity['user_type'] === 'guest' ? esc_html__('Guest', 'shopglut') : esc_html__('Registered', 'shopglut'); ?>
                                        </span>
                                    </td>
                                    <td>
                ...
                <div class="table-container">
                    <div class="table-header">
                        <h3><?php echo esc_html__('Most Wishlisted Products', 'shopglut'); ?></h3>
                        <a href="#" class="view-all-btn export-btn" data-export="top-products">
                            <?php echo esc_html__('Export', 'shopglut'); ?>
                        </a>
                    </div>
                    <div class="table-content">
                        <table class="dashboard-table">
                            <thead>
                                <tr>
                                    <th><?php echo esc_html__('Product', 'shopglut'); ?></th>
                                    <th><?php echo esc_html__('Times Wishlisted', 'shopglut'); ?></th>
                                    <th><?php echo esc_html__('By Guests', 'shopglut'); ?></th>
                                    <th><?php echo esc_html__('By Registered', 'shopglut'); ?></th>
                                    <th><?php echo esc_html__('Stock Status', 'shopglut'); ?></th>
            ...
            <div class="dashboard-quick-actions">
                <div class="quick-actions-header">
                    <h3><?php echo esc_html__('Quick Actions', 'shopglut'); ?></h3>
                </div>
                <div class="quick-actions-grid">
                    <button class="quick-action-btn" data-action="export-all">
                        <span class="btn-icon">📤</span>
                        <span class="btn-text"><?php echo esc_html__('Export All Data', 'shopglut'); ?></span>
                    </button>
                    <button class="quick-action-btn" data-action="export-guest">
                        <span class="btn-icon">👤</span>
                        <span class="btn-text"><?php echo esc_html__('Export Guest Data', 'shopglut'); ?></span>
                    </button>
                    <button class="quick-action-btn" data-action="export-registered">
                        <span class="btn-icon">✅</span>
                        <span class="btn-text"><?php echo esc_html__('Export Registered Users', 'shopglut'); ?></span>
                    </button>
                    <button class="quick-action-btn" data-action="import-data" onclick="document.getElementById('import-file').click()">
                        <span class="btn-icon">📥</span>
                        <span class="btn-text"><?php echo esc_html__('Import Data', 'shopglut'); ?></span>
                    </button>
                    ...
                    <button class="quick-action-btn" data-action="clear-old">
                        ...
                        <span class="btn-text"><?php echo esc_html__('Clean Old Data', 'shopglut'); ?></span>
                    </button>
            ...
            <!-- Import Modal -->
            <div id="import-modal" class="shopglut-modal" style="display: none;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3><?php echo esc_html__('Import Wishlist Data', 'shopglut'); ?></h3>
                        <span class="close-modal">&times;</span>
                    </div>
                    <div class="modal-body">
                        <div class="import-section">
                            <h4><?php echo esc_html__('Select Import Type', 'shopglut'); ?></h4>
                            <div class="import-enhancements">
                                <label>
                                    <input type="radio" name="import_type" value="merge" checked>
                                    <?php echo esc_html__('Merge with existing data', 'shopglut'); ?>
                                </label>
                                <label>
                                    <input type="radio" name="import_type" value="replace">
                                    <?php echo esc_html__('Replace existing data', 'shopglut'); ?>
                                </label>
                            </div>
                        </div>
                        <div class="import-section">
                            <h4><?php echo esc_html__('File Preview', 'shopglut'); ?></h4>
                            <div id="file-preview"></div>
                        </div>
                        <div class="import-section">
                            <h4><?php echo esc_html__('Field Mapping', 'shopglut'); ?></h4>
                            <div id="field-mapping"></div>
                        </div>
                    </div>
                    <div class="modal-footer">
                          <input type="file" id="import-file-input" accept=".csv,.json" style="display: none;">
                        <button class="button button-secondary" id="cancel-import"><?php echo esc_html__('Cancel', 'shopglut'); ?></button>
                        <button class="button button-primary" id="confirm-import"><?php echo esc_html__('Import', 'shopglut'); ?></button>
                    </div>
                </div>
            </div>
        </div>
...
public function enqueueAssets($hook) {
    // Only load on shopglut_wishlist pages (ShopGlut submenu) or wishglut (individual menu)
    if (strpos($hook, 'shopglut_wishlist') === false && strpos($hook, 'wishglut') === false) {
        return;
    }
