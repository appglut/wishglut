...
jQuery(document).ready(function($) {
  ...
  // Import File Handler
    ...
    $('#cancel-import').on('click', function() {
        $('#import-modal').hide();
        window.wishglut_import_ready = false;
    });
    ...
    function showAllActivityModal(userType) {
        var modal = $('<div class="wishglut-modal" id="activity-modal">');
        ...
        $.ajax({
            url: wishglut_wishlist_admin_dashboard.ajax_url,
            type: 'POST',
            data: {
                action: 'get_all_activity',
                user_type: userType,
                nonce: wishglut_wishlist_admin_dashboard.nonce
            },
...
function handleImportFile(file) {
    ...
    formData.append('nonce', wishglut_wishlist_admin_dashboard.nonce);
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.success) {
                ...
                window.wishglut_import_ready = true;
            } else {
...
function confirmImport() {
    ...
    if (!window.wishglut_import_ready) {
