...
trait WishlistCounter {
   ...
   public function menu_counter_custom_styles() {
    ...
    echo '<style type="text/css">
        ...
        .menu-item.wishlist-counter-item .wishglut-wishlist-counter {
            margin: 0;
        }
   ...
   public function get_wishlist_count() {
    ...
    public function wishlist_count_shortcode($atts) {
        ...
        $menu_text = $this->enhancements['wishlist-menu-btn-text'] ?? __('Wishlist', 'wishglut');
        $menu_icon = $this->enhancements['wishlist-menu-btn-icon'] ?? 'fa-solid fa-heart';
        
        $counter_html = sprintf(
        '<a href="%s" class="wishglut-wishlist-counter">
            <i class="%s"></i>
    ...
    return apply_filters('wishglut_wishlist_counter_html', $counter_html, $count, $wishlist_url);
    ...
    if ($args->theme_location == 'primary') {
        ...
        $enhanced_counter = apply_filters('wishglut_wishlist_counter_html', $counter_html, $count, $wishlist_url);
    ...
    private function get_guest_user_id() {
        return isset($_COOKIE['wishglutw_guest_user_id']) ? sanitize_text_field( wp_unslash( $_COOKIE['wishglutw_guest_user_id'] ) ) : '';
    }
}