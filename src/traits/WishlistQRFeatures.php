...
// phpcs:ignore WordPress.Security.NonceVerification.Recommended
        ...
        echo '<h3><i class="fas fa-heart"></i> ' . esc_html__('Shared Wishlist', 'wishglut') . '</h3>';
    ...
    public function render_qr_share_button($list_name) {
        ?>
        <button class="wishglut-qr-share-btn" data-list-name="<?php echo esc_attr($list_name); ?>">
            <i class="fas fa-qrcode"></i> <?php echo esc_html__('Share via QR', 'wishglut'); ?>
        </button>
        <?php
    }
    ...
    public function render_qr_code_modal() {
        ?>
        <div id="wishglut-qr-modal" class="wishglut-modal" style="display: none;">
            <div class="wishglut-modal-content">
                <div class="wishglut-modal-header">
                    <span class="wishglut-modal-close">&times;</span>
                    <h3><i class="fas fa-qrcode"></i> <?php echo esc_html__('Share Wishlist', 'wishglut'); ?></h3>
                </div>
                <div class="wishglut-modal-body">
                    <div class="qr-code-container">
                        <div class="loading"><?php echo esc_html__('Generating QR code...', 'wishglut'); ?></div>
                    </div>
                    <div class="share-enhancements">
                        <div class="share-url-container">
                            <label><?php echo esc_html__('Share URL:', 'wishglut'); ?></label>
                        ...
                        <div class="share-buttons">
                            <button class="download-wishlist-qr-btn">
                                <i class="fas fa-download"></i> <?php echo esc_html__('Download QR', 'wishglut'); ?>
                            </button>
                        </div>
                    </div>
                </div>
        ...
        #wishglut-qr-modal h3 {
            margin: 0;
            font-size: 18px;
            color:#fff;
        }
        
        .wishglut-modal-close {
            color: white;
            font-size: 24px;
            font-weight: bold;
            cursor: pointer;
     ...
     */
    public function wishglut_generate_qr_code() {
