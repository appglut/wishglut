 ...
 *
 */
if ( ! class_exists( 'AGWISHGLUT_color' ) ) {
  class AGWISHGLUT_color extends AGWISHGLUTP {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="agl-color"'. esc_attr($default_attr) . wp_kses_post($this->field_attributes()) .'/>';
