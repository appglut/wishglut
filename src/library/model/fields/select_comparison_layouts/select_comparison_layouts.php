 ...
 *
 */
if ( ! class_exists( 'AGWISHGLUT_select_comparison_layouts' ) ) {
	class AGWISHGLUT_select_comparison_layouts extends AGWISHGLUTP {
		...
		public function render() {
			...
			if ( ! empty( $options ) ) {
				...
				echo '<option value="" disabled>' . esc_html__( 'No comparison layouts found', 'wishglut' ) . '</option>';
			}
