 ...
 *
 */
if ( ! class_exists( 'AGWISHGLUT_group' ) ) {
  class AGWISHGLUT_group extends AGWISHGLUTP {
      ...
      if ( preg_match( '/'. preg_quote( '['. $this->field['id'] .']' ) .'/', $this->unique ) ) {
        ...
        echo '<div class="agl-cloneable-item agl-cloneable-hidden">';
          ...
          foreach ( $this->field['fields'] as $field ) {
            ...
            AGWISHGLUT::field( $field, $field_default, '___'. $field_unique, 'field/group' );
          ...
          foreach ( $this->value as $value ) {
            ...
            echo '<div class="agl-cloneable-item">';
              ...
              foreach ( $this->field['fields'] as $field ) {
                ...
                AGWISHGLUT::field( $field, $field_value, $field_unique, 'field/group' );
