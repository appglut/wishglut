 ...
 *
 */
if (!class_exists('AGWISHGLUT_repeater')) {
	class AGWISHGLUT_repeater extends AGWISHGLUTP {
		...
		public function render() {
			...
			if (preg_match('/' . preg_quote('[' . $this->field['id'] . ']') . '/', $this->unique)) {
				...
				foreach ($this->field['fields'] as $field) {
					...
					AGWISHGLUT::field($field, $field_default, '___' . $field_unique, 'field/repeater');
				...
				if (!empty($this->value) && is_array($this->value)) {
					...
					foreach ($this->value as $key => $value) {
						...
						foreach ($this->field['fields'] as $field) {
							...
							AGWISHGLUT::field($field, $field_value, $field_unique, 'field/repeater');
