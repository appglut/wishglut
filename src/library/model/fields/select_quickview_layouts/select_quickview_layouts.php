 ...
 *
 */
if ( ! class_exists( 'AGWISHGLUT_select_quickview_layouts' ) ) {
	class AGWISHGLUT_select_quickview_layouts extends AGWISHGLUTP {
		...
		public function render() {
			...
			if ( ! empty( $options ) ) {
				...
				echo '<option value="" disabled>' . esc_html__( 'No quick view layouts found', 'wishglut' ) . '</option>';
			}
