...
if (!class_exists('AGWISHGLUT_typography')) {
	/**
	 *
	 * Field: typography
	 *
	 ...
	 * @version 1.0.0
	 */
	class AGWISHGLUT_typography extends AGWISHGLUTP {
		...
		public function render() {
			...
			$args = wp_parse_args(
				...
				array(
					...
					'custom_style' => false,
					'unit' => true,
				// phpcs:ignore WordPressVIPMinimum.Performance.WPQueryParams.PostNotIn_exclude -- This is configuration array, not a database query
					'exclude' => '',
					'line_height_unit' => '',
		...
		public function enqueue() {
			...
			if (!wp_script_is('agl-webfontloader')) {
				...
				AGWISHGLUT::include_plugin_file('fields/typography/google-fonts.php');
