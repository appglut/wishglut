 ...
 *
 */
if ( ! class_exists( 'AGWISHGLUT_textarea' ) ) {
  class AGWISHGLUT_textarea extends AGWISHGLUTP {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        foreach ( $instances as $instance_key ) {
          ...
          if ( isset( AGWISHGLUT::$shortcode_instances[$instance_key] ) ) {

            $button_title = AGWISHGLUT::$shortcode_instances[$instance_key]['button_title'];
