...
/**
 *
 * Field: select_comparison_display
 *
 * @since 1.0.0
 * @version 1.0.0
 *
 */
if ( ! class_exists( 'AGSHOPGLUT_select_comparison_display' ) ) {
	class AGSHOPGLUT_select_comparison_display extends AGSHOPGLUTP {
		...
		public function render() {
			...
			if ( isset( $this->field['options'] ) ) {
				...
				} else if ( is_string( $maybe_options ) && $maybe_options === 'select_comparison_display' ) {
