 ...
 *
 */
if ( ! class_exists( 'AGWISHGLUT_sortable' ) ) {
  class AGWISHGLUT_sortable extends AGWISHGLUTP {
    ...
    public function render() {
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="agl-sortable-item">';

          echo '<div class="agl-sortable-content">';
          ...
          AGWISHGLUT::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="agl-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
