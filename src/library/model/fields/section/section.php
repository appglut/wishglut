 ...
 *
 */
if ( ! class_exists( 'AGWISHGLUT_Field_section' ) ) {
	class AGWISHGLUT_section extends AGWISHGLUTP {
					...
					if ( 'accordion' === $field['type'] ) {
						...
						foreach ( $field['accordions'] as $accordion ) {
							...
							foreach ( $accordion['fields'] as $accordion_field ) {
								...
								AGWISHGLUT::field( $accordion_field, $field_value, $unique_id, 'field/section' );
						...
						AGWISHGLUT::field( $field, $field_value, $unique_id, 'field/section' );
					}
				}
