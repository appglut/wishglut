 ...
 *
 */
if ( ! class_exists( 'AGWISHGLUT_Tax_Options' ) ) {
  class AGWISHGLUT_Tax_Options extends AGWISHGLUT_Abstract{
        ...
        if ( $taxonomy === $this->taxonomy ) {
          ...
          if ( ! empty( $section['fields'] ) ) {
            foreach ( $section['fields'] as $field ) {
              ...
              AGWISHGLUT::field( $field, $this->get_meta_value( $field, $term_id ), $this->unique, 'taxonomy' );
