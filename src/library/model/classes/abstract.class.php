 ...
 *
 */
if ( ! class_exists( 'AGWISHGLUT_Abstract' ) ) {
  abstract class AGWISHGLUT_Abstract {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          if ( $field_type && $field_id ) {
            ...
            AGWISHGLUT::maybe_include_field( $field_type );

            $class_name = 'AGWISHGLUT_' . $field_type;
            ...
            if ( class_exists( $class_name ) ) {
              ...
              if ( method_exists( $class_name, 'output' ) || method_exists( $class_name, 'enqueue_google_fonts' ) ) {
                ...
                if ( $field_output && $this->args['output_css'] ) {
                  AGWISHGLUT::$css .= $instance->output();
                }
