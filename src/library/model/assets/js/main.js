  ...
  $.fn.AGSHOPGLUT_repeater = function () {
    return this.each(function () {
      ...
      $repeater.children(".agl-repeater-add").on("click", function (e) {
        ...
        $cloned_item.find(".agl--switcher").each(function() { $(this).removeClass('wp-color-picker'); });
        $cloned_item.find(".agl-color").each(function() { $(this).removeClass('wp-color-picker'); });
        $cloned_item.find(".agl-fields").agl_reload_script();
   ...
   return this.each( function() {
    ...
    $links.on( 'click', function( e ) {
     e.preventDefault();
      ...
      $link.addClass('agl-tabbed-active').siblings().removeClass('agl-tabbed-active');
      $content.agl_reload_script();
  ...
  $.fn.agl_reload_script = function (options) {
    ...
    return this.each(function () {
      ...
      if (!$this.data("inited")) {
        ...
        $this.children(".agl-field-tax_color").find(".agl-color").agl_color();

        // Field chosenjs
        $this.children(".agl-field-select_filter_page").find(".agl-chosen").agl_chosen();
        $this.children(".agl-field-select_products").find(".agl-chosen").agl_chosen();
        $this.children(".agl-field-select_archive_page").find(".agl-chosen").agl_chosen();
        $this.children(".agl-field-select_banner_pages").find(".agl-chosen").agl_chosen();
        $this.children(".agl-field-select").find(".agl-chosen").agl_chosen();
        $this.children(".agl-field-taxonomy").find(".agl-chosen").agl_chosen();

        $this.children(".agl-field-select_badge_display").find(".agl-chosen").agl_chosen();
        $this.children(".agl-field-select_comparison_display").find(".agl-chosen").agl_chosen();
        $this.children(".agl-field-select_quickview_display").find(".agl-chosen").agl_chosen();
