...
(function ($) {
  ...
  AGSHOPGLUTAjaxChosen.prototype.update_list = function () {
    ...
    var value = $.trim(this.search_field.val());
    var message =
      value.length < this.options.min_length
        ? this.options.typing_text.replace("%s", this.options.min_length - value.length)
        : this.options.searching_text;
    ...
    this.timer = setTimeout(function () {
      ...
      _this.chosenXhr = window.wp.ajax
        .post("agl-chosen", _this.options.data)
  ...
  AbstractChosen = (function () {
    ...
    AbstractChosen.prototype.set_default_values = function () {
      ...
      this.enable_split_word_search =
        this.options.enable_split_word_search != null ? this.options.enable_split_word_search : true;
      ...
      this.display_selected_options =
        this.options.display_selected_options != null ? this.options.display_selected_options : true;
      this.display_disabled_options =
        this.options.display_disabled_options != null ? this.options.display_disabled_options : true;
      this.include_group_label_in_selected = this.options.include_group_label_in_selected || false;
      this.max_shown_results = this.options.max_shown_results || Number.POSITIVE_INFINITY;
      this.case_sensitive_search = this.options.case_sensitive_search || false;
      return (this.hide_results_on_select =
        this.options.hide_results_on_select != null ? this.options.hide_results_on_select : true);
    };
          ...
          if (!(option.group && !this.group_search)) {
            ...
            if (option.search_match) {
              if (query.length) {
                ...
                option.highlighted_html =
                  this.escape_html(prefix) + "<em>" + this.escape_html(fix) + "</em>" + this.escape_html(suffix);
              }
    ...
    AbstractChosen.prototype.get_single_html = function () {
      return (
        ...
        this.default_text +
        '</span>\n  <div><b></b></div>\n</a>\n<div class="chosen-drop">\n  <div class="chosen-search">\n    <input class="chosen-search-input" type="text" autocomplete="off" />\n  </div>\n  <ul class="chosen-results filter-dis"></ul>\n</div>'
      );
    };
    ...
    Chosen.prototype.container_mousedown = function (evt) {
      ...
      if (!(evt != null && $(evt.target).hasClass("search-choice-close"))) {
        if (!this.active_field) {
          ...
          !this.is_multiple &&
          evt &&
          ($(evt.target)[0] === this.selected_item[0] || $(evt.target).parents("a.chosen-single").length)
        ) {
          evt.preventDefault();
          this.results_toggle();
        }
    ...
    applyRule: function (context, enforced) {
      ...
      if (result) {
        $(controls).each(function () {
          $(this).removeClass("agl-depend-on");
        });
